...
1. Copy `skills/policy-comparison/examples/example-output-1.md` to a temporary file.
...
```bash
python3 skills/policy-comparison/scripts/validate_matrix.py /path/to/modified-example.md
```
