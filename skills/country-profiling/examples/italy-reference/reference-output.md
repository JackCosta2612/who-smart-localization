...
- Web-reviewed source inventory: `skills/country-profiling/examples/italy-reference/data/web-reviewed-sources.json`
...
| Web-reviewed sources: Italy | Web-reviewed source | Country Profiling retrieval script | 2026-05-16 retrieval | skills/country-profiling/examples/italy-reference/data/web-reviewed-sources.json | Reviewed HTML, downloaded PDFs, parsed text summaries, file paths, checksums, URLs, and parse statuses | Reviewed |
...
| Italy: health system review 2022 | Institutional profile | European Observatory on Health Systems and Policies | 2022 | skills/country-profiling/examples/italy-reference/data/web-reviewed/downloads/italy-health-system-review-2022.pdf | Detailed health-system organization and policy context | Reviewed |
| Italy: health system summary 2024 | Institutional profile | European Observatory on Health Systems and Policies | 2024 | skills/country-profiling/examples/italy-reference/data/web-reviewed/downloads/italy-health-system-summary-2024.pdf | Updated concise health-system organization, financing, delivery, and reform context | Reviewed |
| Italy: Country Health Profile 2025 | Institutional profile | European Observatory on Health Systems and Policies / OECD / European Commission | 2025 | skills/country-profiling/examples/italy-reference/data/web-reviewed/downloads/italy-country-health-profile-2025.pdf | Current EU-comparable health-system and performance context | Reviewed |
...
| Unresolved source gaps: Italy | Source gap inventory | Country Profiling retrieval script | 2026-05-16 retrieval | skills/country-profiling/examples/italy-reference/data/source-leads.md | Short list of remaining actionable retrieval needs after deterministic and configured web retrieval | Reviewed |
...
- Retrieved baseline indicators: Italy, World Bank and WHO GHO via Country Profiling retrieval script, `skills/country-profiling/examples/italy-reference/data/retrieved-indicators.json`, retrieved 2026-05-16.
- Web-reviewed sources: Italy, Country Profiling retrieval script, `skills/country-profiling/examples/italy-reference/data/web-reviewed-sources.json`, retrieved 2026-05-16.
...
- Italy: health system review 2022, European Observatory on Health Systems and Policies, parsed PDF at `skills/country-profiling/examples/italy-reference/data/web-reviewed/downloads/italy-health-system-review-2022.pdf`, retrieved 2026-05-16.
- Italy: health system summary 2024, European Observatory on Health Systems and Policies, parsed PDF at `skills/country-profiling/examples/italy-reference/data/web-reviewed/downloads/italy-health-system-summary-2024.pdf`, retrieved 2026-05-16.
- Italy: Country Health Profile 2025, European Observatory on Health Systems and Policies / OECD / European Commission, parsed PDF at `skills/country-profiling/examples/italy-reference/data/web-reviewed/downloads/italy-country-health-profile-2025.pdf`, retrieved 2026-05-16.
